...
if(cat.type==="thief"){
  ...
  ctx.fillStyle="#ffd166";ctx.font="bold 18px 'Gatitos UI', Arial, sans-serif, 'Segoe UI Emoji', 'Apple Color Emoji', 'Noto Emoji'";ctx.textAlign="center";drawPawCoin(0,-31,8);

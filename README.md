...
<div id="musicMenuControls" class="musicMenuControls" aria-label="Controles de música">
  <button id="musicMenuToggle" type="button">🎵 Música activada</button>
  <label for="musicVolumeRange">Volumen</label>
  <input id="musicVolumeRange" type="range" min="0" max="100" value="28"/>
  <span id="musicVolumeValue">28%</span>
</div>
...
<div id="pauseBox">
<h2>⏸️ Pausa</h2>
<div id="pauseMusicControls" class="musicMenuControls pauseMusicControls" aria-label="Controles de música en pausa">
  <button id="pauseMusicToggle" type="button">🎵 Música activada</button>
  <label for="pauseMusicVolumeRange">Volumen</label>
  <input id="pauseMusicVolumeRange" type="range" min="0" max="100" value="28"/>
  <span id="pauseMusicVolumeValue">28%</span>
</div>
